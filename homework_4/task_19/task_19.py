...
from homework_4.task_20.task_20_functions import read_file_with_equation
...
generate_file_with_answer(final_equation, "task_19_answer.txt")
read_file_with_equation("task_19_answer.txt")